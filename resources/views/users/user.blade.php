...
<div class="w3-top">
    <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
        ...
        <li class="w3-hide-small w3-right"><li class="w3-hide-small w3-dropdown-hover">
            <a href="#" class="w3-padding-large w3-hover-white" title="My Account"><i class="fa glyphicon glyphicon-user"></i><span class="w3-badge w3-right w3-small w3-green">3</span></a>
            <div class="w3-dropdown-content w3-white w3-card-4">
                <a href="#">One new friend request</a>
                <a href="#">John Doe posted on your wall</a>
                <a href="#">Jane likes your post</a>
                        ...
                        <div class="alert">
                            ...
                            {{--@foreach($posts as $post)--}}
                                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                                    ...
                                    <span class="w3-right w3-opacity">001</span>
                                    <h4>Temp</h4><br>
                                    <hr class="w3-clear">
